...
const Projects = () => {
  ...
  return (
    <section id="projects" className="max-w-[1638px] mx-auto px-6 md:px-16 py-16">
      <h2
      ...
      <div className="relative mb-20">
        ...
        {reversedProjects.map((project, i) => {
          ...
          return (
            <div
              key={i}
              className={`mb-12 flex w-full justify-center opacity-0 section-item-animate ${i % 2 === 0 ? "md:justify-start" : "md:justify-end"
                }`}
              style={{ animationDelay: `${200 + i * 200}ms` }}
            >
              <div
                className="relative w-full md:w-5/12 p-6 bg-[var(--color-surface)] rounded-lg shadow-md 
